...
describe('quem sobreviveu?', () => {
  ...
  afterEach(() => console.log('Quem ainda sobrevive:', adventure.specialists.map(specialist => specialist.nome)));
  afterAll(() => console.log(`O especialista mais brabo (o único sobrevivente) é ${adventure.specialists[0].nome}, the ${adventure.specialists[0].classe}!!!`))
