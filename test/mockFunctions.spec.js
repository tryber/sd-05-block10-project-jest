...
describe('verifica as funções e os mocks', () => {
  ...
  test('testa função add', () => {
    ...
    mockFunctions.add(2, 5);

    expect(mockFunctions.add).toHaveBeenCalled();
    expect(mockFunctions.add).toHaveBeenCalledTimes(1);
    expect(mockFunctions.add).toHaveBeenCalledWith(2, 5);
    expect(mockFunctions.add(2, 5)).toEqual(7);
  ...
  test('testa função subtract', () => {
    ...
    expect(mockFunctions.subtract(5, 2)).toEqual(3);
  ...
  test('testa função multiply', () => {
    ...
    mockFunctions.multiply(2, 5);

    expect(mockFunctions.multiply).toHaveBeenCalled();
    expect(mockFunctions.multiply).toHaveBeenCalledTimes(1);
    expect(mockFunctions.multiply).toHaveBeenCalledWith(2, 5);
    expect(mockFunctions.multiply(2, 5)).toEqual(10);
  ...
  test('testa função divide', () => {
    ...
    mockFunctions.divide(10, 5);

    expect(mockFunctions.divide).toHaveBeenCalled();
    expect(mockFunctions.divide).toHaveBeenCalledTimes(1);
    expect(mockFunctions.divide).toHaveBeenCalledWith(10, 5);
    expect(mockFunctions.divide(10, 5)).toEqual(2);
